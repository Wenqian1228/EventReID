...
class NetworkBasic(torch.nn.Module):
    def __init__(self, netParams,
        ...
        self.neuron_config.append(
            getNeuronConfig(theta=theta[3], tauSr=tauSr[3], tauRef=tauRef[3], scaleRef=scaleRef[3], tauRho=tauRho[3],
                            scaleRho=scaleRho[3]))
        ...
        self.conv4 = self.slayer4.conv(4, 4, 3, padding=1)
    ...
    def forward(self, spikeInput):
        ...
        img.save('/ghome/caocz/code/Event_Camera/Event_Re_ID/VideoReID_PSTA/SNN_visual/{}_input.jpg'.format(self.global_num))
        ...
        _spikes_layer_1 = (a * 255).astype(np.uint8) # 转换成uint8类型
        img = Image.fromarray(_spikes_layer_1)
        img.save('/ghome/caocz/code/Event_Camera/Event_Re_ID/VideoReID_PSTA/SNN_visual/{}_spikes.jpg'.format(self.global_num))
        ...
        _spikes_layer_1 = (a * 255).astype(np.uint8) # 转换成uint8类型
        img = Image.fromarray(_spikes_layer_1)
        img.save('/ghome/caocz/code/Event_Camera/Event_Re_ID/VideoReID_PSTA/SNN_visual/{}_spikes1.jpg'.format(self.global_num))
        ...
        img.save('/ghome/caocz/code/Event_Camera/Event_Re_ID/VideoReID_PSTA/SNN_visual/{}_spikes2.jpg'.format(self.global_num))
        ...
        img.save('/ghome/caocz/code/Event_Camera/Event_Re_ID/VideoReID_PSTA/SNN_visual/{}_spikes3.jpg'.format(self.global_num))

        #########################################################
        spikes_layer_4 = self.slayer4.spike(self.conv4(self.slayer4.psp(spikes_layer_3)))
        _spikes_layer_4 = spikes_layer_4[0][0][0].cpu().data.numpy()
        ...
        img.save('/ghome/caocz/code/Event_Camera/Event_Re_ID/VideoReID_PSTA/SNN_visual/{}_spikes4.jpg'.format(self.global_num))
