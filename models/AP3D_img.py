...
#############################################################################
        ...
        # self.os_conv_layer1 = AP3D_block(self.plances,self.plances)
        # self.os_conv_layer2 = AP3D_block(self.plances,self.plances)
        # self.os_conv_layer3 = AP3D_block(self.plances,self.plances)

        self.os_conv_layer1 = AP3D_block(8,8)
        self.os_conv_layer2 = AP3D_block(8,8)
        self.os_conv_layer3 = AP3D_block(8,8)
    ...
    def forward(self, x, pids=None, camid=None):    # x=[16,8,3,256,128]
        ...
        feat_map_2 = self.os_conv_layer2(feat_map_1)
        ...
        feat_map_3 = self.os_conv_layer3(feat_map_2)
