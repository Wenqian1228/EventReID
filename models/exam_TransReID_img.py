...
class TransReID_Net(nn.Module):

    def __init__(self, num_classes=100, seq_len=8):
        super(TransReID_Net, self).__init__()
...
#############################################################################
        ...
        self.trans_layer1 = NonLocalBlock(self.plances)
        self.trans_layer2 = NonLocalBlock(self.plances)
        self.trans_layer3 = NonLocalBlock(self.plances)
    ...
    def forward(self, x, pids=None, camid=None):    # x=[16,8,3,256,128]
        ...
        feat_map_3 = self.trans_layer3(feat_map_2)
