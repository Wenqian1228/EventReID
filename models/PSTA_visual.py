...
class PSTA_visual(nn.Module):
    ...
    def forward(self, x, pids=None, camid=None):    # x=[16,8,3,256,128]
        ...
        # _save_path='{}/000{}.png'.format(_root_path,_rand_seed)
        # _save_person_path = '{}/000{}_person.png'.format(_root_path,_rand_seed)
        _save_both_path = '{}/000{}_both.png'.format(_root_path,_rand_seed)
        print('_save_both_path=',_save_both_path)
        # V.save_feature(f1, save_path=_save_path)
        # V.save_image(img, save_path=_save_person_path, recover=False)
