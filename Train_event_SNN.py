...
parser.add_argument('--arch', type=str, default='SNN_exam', choices=['ResNet50', 'PSTA', 'HiCMD_img', 'OSNet_img', 'SRS_img', 'STMN_img', 'TransReID_img','CCReID_img','MCNL_img','SNN_exam'])
...
parser.add_argument('--dataset', type=str, default='iLIDSVID_event', choices=['mars','duke','prid','prid_event','prid_event_vid','iLIDSVID_event'])
...
def main():
    ...
    # 数据集的初始化操作
    if args_.dataset == 'prid' or args_.dataset == 'prid_event':
