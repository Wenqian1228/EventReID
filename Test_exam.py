...
parser.add_argument("--config_file", default="./configs/softmax_triplet_mars.yml", help="path to config file", type=str)
parser.add_argument("opts", help="Modify config options using the command-line", default=None,nargs=argparse.REMAINDER)
parser.add_argument('--arch', type=str, default='PSTA_visual', choices=['ResNet50', 'PSTA','PSTA_visual','OSNet_visual'])
...
parser.add_argument('--test_path', type=str, default='/ghome/caocz/code/Event_Camera/Event_Re_ID/VideoReID_PSTA/pth/Mars.pth')
...
def main():
    ...
    # 数据集的初始化操作
    if args_.dataset == 'prid' or args_.dataset == 'prid_dark' or args_.dataset == 'prid_dark2' or args_.dataset == 'Low' or args_.dataset == 'prid_dark2_SCI' or args_.dataset == 'PRID_blur9_10' or args_.dataset == 'PRID_blur19_20' or args_.dataset == 'PRID_blur29_30' or args_.dataset == 'PRID_block':
