...
parser.add_argument("--config_file", default="./configs/softmax_triplet_mars128.yml", help="path to config file", type=str)
parser.add_argument("opts", help="Modify config options using the command-line", default=None,nargs=argparse.REMAINDER)


#######################################################################
parser.add_argument('--arch', type=str, default='OSNet_SNN', choices=['ResNet50', 'PSTA','PSTA_img_event_cat','PSTA_img_event_deform1','PSTA_img_event_deform2','PSTA_img_event_deform1128','HiCMD_Net_deform1','OSNet_deform1','STMN_Net_deform1','TransReID_Net_deform1','SRS_Net_deform1','HiCMD_img', 'OSNet_img', 'SRS_img', 'STMN_img', 'TransReID_img','CCReID_img','HiCMD_Net_deform2','OSNet_deform2','STMN_Net_deform2','TransReID_Net_deform2','SRS_Net_deform2','CC_Net_deform2','HiCMD_Net_deform3','OSNet_deform3','STMN_Net_deform3','TransReID_Net_deform3','SRS_Net_deform3','CC_Net_deform3','PSTA_img_event_deform3', 'OSNet_SNN'
                                                                      ])
...
parser.add_argument('--dataset', type=str, default='mars_event_vid', choices=['mars','duke','prid','prid_event','prid_event_vid','mars_event_vid','prid_dark2_event_vid','Low_event_vid','iLIDSVID_event_vid','iLIDSVID_event_vid_blur4_5','iLIDSVID_block_event','PRID_blur_event'])
...
def main():
    ...
    # 数据集的初始化操作
    if args_.dataset == 'prid' or args_.dataset == 'prid_event' or args_.dataset =='prid_event_vid' or args_.dataset =='prid_dark2_event_vid' or args_.dataset =='Low_event_vid'  or args_.dataset =='PRID_blur_event':
