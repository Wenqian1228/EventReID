...
parser.add_argument('--arch', type=str, default='SINet', choices=['ResNet50', 'PSTA', 'HiCMD_img', 'OSNet_img', 'SRS_img', 'STMN_img', 'TransReID_img','CCReID_img','MCNL_img','GRL_img','STGCN_img','SINet','BiCNet','TCLNet','AP3D_img'])
...
parser.add_argument('--dataset', type=str, default='pride', choices=['mars','iLIDSVID','duke','prid','prid_dark','prid_dark2','Low','prid_dark2_SCI','PRID_blur9_10','PRID_blur19_20','PRID_blur29_30','iLIDSVID_blur4_5','PRID_block','iLIDSVID_block','iLIDSVID_dark','iLIDSVID_dark_SCI','Low_SCI','PRID_mat_img','iLIDSVID_dark_LIME','PRID_dark2_LIME','Low_LIME','pride'])
...
def main():
    ...
    cfg.RANDOM_SEED = random.randint(1,1000)
    ...
    # 数据集的初始化操作
    if args_.dataset == 'prid' or args_.dataset == 'prid_dark' or args_.dataset == 'PRID_mat_img' or args_.dataset == 'prid_dark2' or args_.dataset == 'Low' or args_.dataset == 'PRID_dark2_LIME' or args_.dataset == 'Low_SCI' or args_.dataset == 'Low_LIME' or args_.dataset == 'prid_dark2_SCI' or args_.dataset == 'PRID_blur9_10' or args_.dataset == 'PRID_blur19_20' or args_.dataset == 'PRID_blur29_30' or args_.dataset == 'PRID_block' or args_.dataset == 'pride':
...
def train(model, trainloader, xent, tent, optimizer, use_gpu):
    ...
    for batch_idx, (imgs, pids, _, _) in enumerate(trainloader):
        ...
        # 网络输入在这里
        ############################################
        outputs, features = model(imgs) # imgs=[[16, 8, 3, 256, 128]]
