...
parser.add_argument("--config_file", default="./configs/softmax_triplet_prid_event128.yml", help="path to config file", type=str)
parser.add_argument("opts", help="Modify config options using the command-line", default=None,nargs=argparse.REMAINDER)
parser.add_argument('--arch', type=str, default='OSNet_visual', choices=['ResNet50', 'PSTA', 'HiCMD_img', 'OSNet_img', 'SRS_img', 'STMN_img', 'TransReID_img','CCReID_img','MCNL_img','SNN_exam','PSTA_visual','OSNet_visual','GRL_img','STGCN_img','SINet','BiCNet','TCLNet','AP3D_img'])
...
parser.add_argument('--dataset', type=str, default='prid_event', choices=['mars','duke','prid','prid_event','prid_event_vid','iLIDSVID_event','Low_event'])
...
def main():
    ...
    # 数据集的初始化操作
    if args_.dataset == 'prid' or args_.dataset == 'prid_event' or args_.dataset == 'Low_event':
